...
namespace Data.Migrations.Migrations
{
    ...
    [Migration("20250717175500_UserChatReadStatus")]
    partial class UserChatReadStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.UserChatReadStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<DateTimeOffset>("LastReadMessageTimestamp")
                        .HasColumnType("datetimeoffset")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_chat_read_statuses");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_chat_read_statuses_user_id");

                    b.HasIndex("ChatId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_user_chat_read_statuses_chat_id_user_id");

                    b.ToTable("user_chat_read_statuses", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserChatReadStatus", b =>
                {
                    b.HasOne("Domain.Entities.Chat", null)
                        .WithMany("UserChatReadStatuses")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_user_chat_read_statuses_chats_chat_id");
                    ...
                    b.HasOne("Domain.Entities.User", null)
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_user_chat_read_statuses_users_user_id");
                });

            modelBuilder.Entity("Domain.Entities.Chat", b =>
                {
                    b.Navigation("UserChatReadStatuses");
                });
